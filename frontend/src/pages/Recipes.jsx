...
export default function Recipes() {
  ...
  return (
    <div className="pb-4">
      {/* Header */}
      <div className="mb-4">
        <h1 className="text-xl font-bold text-gray-100">Homemade Recipes</h1>
        <p className="text-sm text-gray-500">Healthier versions you can make at home</p>
      </div>
      ...
      <div className="bg-gray-950 rounded-xl p-4 shadow-sm mb-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
          >
      ...
      {loading ? (
        ...
        <>
          {/* Results Count */}
          <p className="text-sm text-gray-500 mb-3">{recipes.length} recipes found</p>

          {/* Recipes Grid */}
          {recipes.length === 0 ? (
            <div className="text-center py-12">
              <div className="text-6xl mb-4">🍳</div>
              <h2 className="text-xl font-semibold text-gray-100 mb-2">No recipes found</h2>
            ...
            <div className="space-y-3">
              {recipes.map(recipe => (
                <Link
                  ...
                  className="block bg-gray-950 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow"
                >
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-100 mb-1">{recipe.name}</h3>
